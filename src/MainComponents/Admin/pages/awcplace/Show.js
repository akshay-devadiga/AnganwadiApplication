...
class Show extends Component {
  ...
  render() {
    return (
      <AdminLayout>
        <h3 style={globalStyles.title}>Edit awc place</h3>
        <div>
        ...
        {!this.state.successindicator ? (
          <div style={styles.buttons}>
            <Link
              to={`../awcplaceEdit/${this.state.awcplaceid}`}
              style={{ textDecoration: "none" }}
            >
              <Button variant="contained">Edit</Button>
            </Link>
            <Button
              onClick={this.delete.bind(this, this.state.awcplaceid)}
