      ...
      .then(result => {
        ...
        for (i = 0; i < data.length; i++) {
          if (data[i].anganwadicode === anganwadicode) {
            ...
            villagename = data[i].anganwadidetails.villagename;
            talukname = data[i].anganwadidetails.talukname;
            awcplacename = data[i].anganwadidetails.awcplace;
            //-------//
